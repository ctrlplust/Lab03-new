...
public class Main {
    public static void main(String[] args) {
        ArrayList<Game> initialGames = new ArrayList<>(Arrays.asList(
                ...
                new Game("Red Dead Redemption 2", "Action-Adventure", 30000, 98),
                new Game("Doom Eternal", "FPS", 20000, 90),
                new Game("Zelda: BOTW", "Action-Adventure", 40000, 97),
                new Game("Stardew Valley", "Simulation", 10000, 96),
                new Game("Dark Souls 3", "Action-RPG", 20000, 89),
                new Game("Hades", "Roguelike", 15000, 93),
                new Game("Celeste", "Platformer", 12000, 92),
        ...
        gameDataset.sortByAlgorithm("collections.sort", "category"); // "collections.sort" es un ejemplo, podría ser cualquier cosa no reconocida
        gameDataset.getData().forEach(System.out::println);
        System.out.println("Ordenado por: " + gameDataset.getSortedByAttribute());
